...
TEST(TreeTest, Insert_increased_Order) {
    AvlTree avl;
    avl.insert(1);
    avl.insert(2);
    avl.insert(3);
...
TEST(TreeTest, Insert_decrease_Order) {
    AvlTree avl;
    avl.insert(10);
    avl.insert(9);
    avl.insert(8);
...
TEST(TreeTest, Insert_random_Order) {
    AvlTree avl;
    avl.insert(4);
    avl.insert(8);
    avl.insert(2);
...
TEST(TreeTest, Insert_Same_Nodes) {
    AvlTree avl;
    avl.insert(4);
    avl.insert(8);
    avl.insert(4);
...
TEST(TreeTest, Remove_unavailable_Node) {
    AvlTree avl;
    avl.insert(4);
    avl.insert(2);
    avl.insert(5);
    avl.insert(3);
    EXPECT_FALSE(avl.search(6));
    avl.remove(6);
    EXPECT_TRUE(avl.isBalanced());
    EXPECT_FALSE(avl.search(6));
}

TEST(TreeTest, Remove_SameNodeTwice) {
    AvlTree avl;
    avl.insert(1);
    avl.insert(2);
    avl.insert(3);
...
TEST(TreeTest, Remove_RightNode) {
    AvlTree avl;
    avl.insert(2);
    avl.insert(1);
    avl.insert(3);
...
TEST(TreeTest, Remove_with_DoubleRotate) {
    AvlTree avl;
    avl.insert(5);
    avl.insert(3);
    avl.insert(8);
